...
TREE_PATH="${TREE_PATH:-../../../../mocaccino/portage-tree/amd64}"
COMMON_TREE_PATH="${COMMON_TREE_PATH:-../../../../mocaccino/portage-tree/multi-arch}"
CONCURRENCY=${CONCURRENCY:-1}
TASK_NAME_PREFIX="${TASK_NAME_PREFIX:-AMD64 mocaccinoos/portage-tree: }"
LUET_OPTS="${LUET_OPTS:-}"
MCLI_OPTS="${MCLI_OPTS:-}"
