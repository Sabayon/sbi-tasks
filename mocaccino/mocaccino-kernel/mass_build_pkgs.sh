...
TREE_PATH="${TREE_PATH:-../../../../mocaccino/mocaccino-kernel/amd64}"
COMMON_TREE_PATH="${COMMON_TREE_PATH:-../../../../mocaccino/mocaccino-kernel/multi-arch}"

CONCURRENCY=${CONCURRENCY:-1}
TASK_NAME_PREFIX="${TASK_NAME_PREFIX:-AMD64 mocaccinoos/mocaccino-kernel: }"
LUET_OPTS="${LUET_OPTS:-}"
MCLI_OPTS="${MCLI_OPTS:-}"
REPO_URL="${REPO_URL:-https://github.com/mocaccinoOS/kernel-repo.git}"
